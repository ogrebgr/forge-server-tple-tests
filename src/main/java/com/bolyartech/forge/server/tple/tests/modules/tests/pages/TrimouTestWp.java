...
public class TrimouTestWp extends WebPage {
    public TrimouTestWp(TemplateEngineFactory templateEngineFactory) {
    ...
    public String produceHtml(RequestContext ctx, TemplateEngine tple) {
        ...
        return tple.render("trimou/index-trimou.mustache");
    }
}
