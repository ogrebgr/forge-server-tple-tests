...
public class MustacheWp extends WebPage {
    public MustacheWp(TemplateEngineFactory templateEngineFactory) {
    ...
    public String produceHtml(RequestContext ctx, TemplateEngine tple) {
        tple.assign("from", "Mustache template engine");

        return tple.render("mustache.tpl");
    }
}
